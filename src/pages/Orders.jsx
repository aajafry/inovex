...
export default function Orders() {
  ...
  return (
    <>
      <Paper elevation={2} className="w-full flex justify-between items-center overflow-hidden">
      ...
      <Paper elevation={2} className="w-full flex justify-start items-center p-2 cursor-pointer overflow-hidden">
          <Button className=" bg-inherit text-slate-800" 
